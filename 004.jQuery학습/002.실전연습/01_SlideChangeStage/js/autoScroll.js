...
$(function () { ///////////// jQB /////////////////
  /* 
      ...
      - 2019년도에 위의 세가지 중요객체에 대하여 기본기능 막기를 할 수 없도록
        브라우저 소스가 업데이트 되었는데 그 이유는, 모바일에서 에러가 발생하는
        문제의 원인으로 지목되어 본 3가지 중요객체에 대해서는 e.preventDefault()
        또는 return false를 사용한 기능막기를 못하도록 하였다!
  ...
  */
  ...
  $(document).on("mousewheel DOMMouseScroll", function (e) {
    ...
    // e.preventDefault();
    // return false;
    // 기본막기시 에러발생! 왜? document이니까!
    // 스크롤안되게 하려고 html, body에 css로 
    // overflow:hidden을 줘서 기본기능을 대신 막는다!
    ...
    // 사용할 수 있도록 보완코드를 작성해야 한다!
    // 변수 = 경우1 || 경우2;
    // 변수에 경우1과 경우2중 true(유효한것)이 먼저 할당됨!


    /* 
        [ 마우스휠 방향 알아내기 위한 값 -> wheelDelta ]
        - 휠델타란? 마우스 이벤트에 따라 발생하는 이벤트 횟수 및 방향,
          이동거리 등의 정보를 제공함
        - ie, chrome 등 브라우저 공용
    ...
    */
    ...
    if (/Firefox/i.test(navigator.userAgent)) {
      delta = -delta; // 변수앞에 마이너스를 쓰면 부호반대!
    } ///////////// 파이어폭스 여부 if문 //////////////////
